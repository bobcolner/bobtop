...
use crate::core::sample::{Container, ProcessInfo, ProcessSample, ProcessState};
use crate::core::{Collector, Result};
use crate::pid_attr::AttributionStore;
use sysinfo::{ProcessRefreshKind, ProcessStatus, ProcessesToUpdate, System, UpdateKind, Users};

use crate::collectors::container::NameResolver;
            ...
            let static_info = match static_cache.remove(&pid_u32) {
                ...
                _ => {
                    ...
                    let container = {
                        ...
                        crate::collectors::container::detect(
