...
//! this is an honest stub: `available()` returns `false`, so [`crate::pid_attr::select`]
//! falls through to [`crate::pid_attr::UnavailableAttributor`] on macOS rather than
//! pretending to work.

use async_trait::async_trait;

use crate::pid_attr::{AttributorTier, NetError, NetworkAttributor, ProcessNetSample, Result};
