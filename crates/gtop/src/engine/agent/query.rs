...
pub fn history_metric_for(m: Metric) -> Result<crate::core::Metric, String> {
    Ok(match m {
        Metric::Cpu => crate::core::Metric::Cpu,
        Metric::Mem => crate::core::Metric::Mem,
        Metric::NetTx => crate::core::Metric::NetTx,
        Metric::NetRx => crate::core::Metric::NetRx,
...
mod tests {
    use super::*;
    use crate::core::sample::{ProcessSample, ProcessState};
