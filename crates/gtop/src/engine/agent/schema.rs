...
//! `gtop::core::sample` — the wire format is a public contract that ages
//! independently of internal struct shapes. Convert at the boundary.

use std::time::{SystemTime, UNIX_EPOCH};

use crate::core::{HostSample, PeakResult, ProcRef, WindowStats};
...
/// Mirrors `crate::core::ProcRef` but is the serialization-stable form.
#[derive(Debug, Clone, Serialize)]
pub struct RespRef {
    pub pid: u32,
    pub name: String,
