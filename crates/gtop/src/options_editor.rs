...
use gtui::widgets::{SettingRow, SettingValue, SettingsForm};
    ...
    pub fn from_app(app: &App) -> Self {
        ...
        let state = OptionsState {
            ...
            corners: match app.corner_style {
                gtui::widgets::CornerStyle::Rounded => CornerChoice::Rounded,
                gtui::widgets::CornerStyle::Square => CornerChoice::Square,
            },
            no_ebpf: false,
            no_pcap: false,
            tty: app.tty_graphs,
