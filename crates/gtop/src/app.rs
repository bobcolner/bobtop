...
pub struct App {
    ...
    pub panel_sizes: gtui::PanelSizes,
    pub tty_graphs: bool,
    ...
    pub scopes: gtui::ScopeStack<crate::keys::Action>,
}
...
impl App {
    pub fn new(
        ...
        let panel_sizes = gtui::PanelSizes::from_preset(layout_preset);
        Self {
            theme,
            layout_preset,
            panel_sizes,
            ...
            attribution: None,
            scopes: gtui::ScopeStack::new(Box::new(crate::keys::BaseScope)),
        }
    }
    ...
    pub fn set_layout(&mut self, preset: LayoutPreset) {
        ...
        self.panel_sizes = gtui::PanelSizes::from_preset(preset);
    ...
    /// settings. Theme list is queried from the gtui builtin
    ...
    ///   the 256-palette (btop's algorithm — `gtui::downsample_256`).
