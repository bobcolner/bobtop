//! `MonitorTheme` — system-monitor overlay on top of the generic `gtui::Theme`.
//!
...
/// [`gtui::downsample_theme_to_256`] for the base, then converts
