...
//!
//! Both bobtop-daemon (kill confirm) and bobtop-fb (rename / touch /
...
//!   `BoxedPanel::with_controls` (bobtop-fb style — quieter).
//! - `with_actions(items)` renders an [`ActionBar`] inside the body
//!   bottom row (bobtop-daemon style — louder, colored).
//!
